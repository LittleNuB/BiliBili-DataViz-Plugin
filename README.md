...
0.10.0-alpha 当前范围包括 Bili-Bill 内容账单、动态账单、智能收藏、当前视频助手、Smart Favorites Q&A 与 Video Knowledge v0。
...
- Smart Favorites Q&A 支持基于本地收藏索引的问答，回答需要引用来源视频并解释相关性。
- 当前视频助手支持基于当前视频的元数据、简介或可用字幕来源回答，并标注所用来源层级。
- Video Knowledge v0 支持基于页面、章节、字幕片段或用户保存证据的关键节点；跳转建议需要用户确认。
