...
### GATE-014-A：公开安全 fixture 与基准收据框架
...
- 固定并输出分段长度、每视频分段数、重叠率、中英文比例、标点和时长分布；任何“接近真实 B 站字幕”的声明都必须能由这份公开安全统计轮廓证伪。
- fixture 只使用合成/公开安全文本，不含真实用户历史、收藏、字幕、账号或环境路径。

不包含：选择搜索或 ZIP 方案。

验收：同一 seed 重跑得到一致哈希和记录数；fixture 可分批生成、清理且不会进入发布包；focused tests 与隐私扫描通过。
...
1. 合并 DOC-014。
2. 依次完成 GATE-014-A、B；随后并行推进 C/D；最后 E 裁决。
...
| --- | --- | --- | --- |
| DOC-014 | #236 | GATE-014-A | #237 |
| GATE-014-B | #238 | GATE-014-C | #239 |
| GATE-014-D | #240 | GATE-014-E | #241 |
| DB-014-A | #242 | KB-014-A | #243 |
| SRC-014-A | #244 | SRC-014-B | #245 |
| KA-014-A | #246 | FT-014-A | #247 |
| FT-014-B | #248 | KA-014-B | #249 |
| SEARCH-014 | #250 | BACKUP-014-A | #251 |
| BACKUP-014-B | #252 | QA-014-0 | #253 |
| AI-014-A | #254 | AI-014-B | #255 |
| AI-014-C | #256 | QA-014-1 | #257 |
