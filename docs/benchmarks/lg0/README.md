...
当前正式基线是干净提交 `3040206b980477f3a9cc989b9f2117901226b513` 的 [第三轮 48-run 收据](2026-09-06T08-40-01-622Z-324b51e8/report.json)、[测前记录](2026-09-06T08-40-01-622Z-324b51e8/preflight.json)及 [裁决](2026-09-06T08-40-01-622Z-324b51e8/verdict.json)。CLI 同时验证干净提交 blob、当前源码和收据绑定。前两轮保留为历史诊断，三轮合计 144 次，不覆盖失败、不跨轮挑最好值。
...
- `node scripts/lg0/verify-report.mjs --verify docs/benchmarks/lg0/2026-09-06T08-40-01-622Z-324b51e8`：检查场景、次数、计时、容量、故障、干净提交及当前源码绑定；验证器 PASS 不等于候选通过。
